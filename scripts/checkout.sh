...
echo "Simulith..."
gnome-terminal --window-with-profile=KeepOpen --title="Simulith" -- $DFLAGS -v $SIM_DIR:$SIM_DIR --name $SC_NUM"-simulith" -h simulith --network=$SC_NETNAME -w $SIM_BIN/../simulith $DBOX ./simulith_server_standalone
echo ""
